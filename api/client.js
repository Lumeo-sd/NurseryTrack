...
export const varietiesAPI = {
  ...
  getById: (id) =>
    api.get(`/varieties/${id}`),

  create: (varietyData) =>
    api.post('/varieties', varietyData),

  update: (id, varietyData) =>
    api.put(`/varieties/${id}`, varietyData),

  delete: (id) =>
    api.delete(`/varieties/${id}`),
};
...
export const actionLogsAPI = {
  getForBatch: (batchId) =>
    api.get(`/action-logs/batch/${batchId}`),

  getForUser: () =>
    api.get('/action-logs/user'),
